...
def collect_files(root: Path) -> List[Path]:
    ...
    for path in root.rglob('*'):
        if path.is_file() and path.suffix.lower() in TARGET_EXTENSIONS:
            # Verifica se alguma parte do caminho está na lista negra
...
def main():
    ...
    parser.add_argument("--root", required=True, help="Pasta raiz do projeto para análise")
    parser.add_argument("--dst", required=True, help="Caminho do arquivo Markdown de saída")
